...
class OdometryPublisher:
    def __init__(self):
        ...
        # Subscribe to the /master_pid_vel topic
        self.vel_sub = rospy.Subscriber('/master_pid_vel', Twist, self.velocity_callback)
    ...
    def velocity_callback(self, msg):
        ...
        # Velocities from the Twist message
        vx = msg.linear.x
        vy = msg.linear.y
...
#         self.vel_sub = rospy.Subscriber('/MultiFloatArray_34', Float32MultiArray, self.velocity_callback)
