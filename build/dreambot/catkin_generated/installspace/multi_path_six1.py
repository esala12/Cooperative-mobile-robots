...
class MultiPathSubscriberNode:
    def __init__(self):
        ...
        rospy.init_node('multi_path_subscriber_node_six1', anonymous=True)
        ...
        # self.b_coordinate = [3.5, 0]
        # self.c_coordinate = [7, 0]
        # self.f_coordinate = [7, -3.5]
        # self.d_coordinate = [0, -3.5]
        # self.e_coordinate = [3.5, -3.5]
