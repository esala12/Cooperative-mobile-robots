...
class TfMasterbot(object):
    ...
    def __init__(self):
        ...
        self.odom_sub_ = rospy.Subscriber("/slavebot_kalman", Odometry, self.imuCallback)
        ...
        self.static_transform_map.child_frame_id = "slave_odom"
        ...
        self.static_transform_lidar.header.frame_id = "slave_base_footprint_ekf"
        self.static_transform_lidar.child_frame_id = "slave_lidar"
        ...
        self.static_transform_imu.header.frame_id = "slave_base_footprint_ekf"
        self.static_transform_imu.child_frame_id = "IMU_sensor_slave"
    ...
    def imuCallback(self, msg):
        ...
        dynamic_transform.header.frame_id = "slave_odom"
        dynamic_transform.child_frame_id = "slave_base_footprint_ekf"
...
if __name__ == '__main__':
    rospy.init_node('tf_kalman_slave_node')
