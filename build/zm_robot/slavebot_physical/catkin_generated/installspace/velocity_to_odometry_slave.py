...
class OdometryPublisher:
    def __init__(self):
        # Initialize the node
        rospy.init_node('odometry_publisher_slave', anonymous=True)
        
        # Subscribe to the velocity topic
        self.vel_sub = rospy.Subscriber('/current_robot_velocity_slave', Float32MultiArray, self.velocity_callback)
        
        # Publisher for odometry
        self.odom_pub = rospy.Publisher('/slavebot_kalman', Odometry, queue_size=10)
    ...
    def publish_odometry(self, current_time, vx, vy, vtheta):
        ...
        # Set the velocity
        odom.child_frame_id = 'base_link_slave'
