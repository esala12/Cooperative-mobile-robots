...
"""autogenerated by genpy from dreambot/TargetVelocityActionResult.msg. Do not edit."""
import codecs
import sys
...
class TargetVelocityActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "dreambot/TargetVelocityActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dreambot/TargetVelocityResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TargetVelocityActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dreambot.msg.TargetVelocityResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dreambot.msg.TargetVelocityResult()
