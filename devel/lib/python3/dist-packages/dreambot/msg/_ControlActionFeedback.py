...
"""autogenerated by genpy from dreambot/ControlActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ControlActionFeedback(genpy.Message):
  _md5sum = "38f9d29e68ce9c1f364514cda9c83dcb"
  _type = "dreambot/ControlActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dreambot/ControlFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ControlActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dreambot.msg.ControlFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dreambot.msg.ControlFeedback()
