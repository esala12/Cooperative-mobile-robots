...
"""autogenerated by genpy from dreambot/ReachGoalActionResult.msg. Do not edit."""
import codecs
import sys
...
class ReachGoalActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "dreambot/ReachGoalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dreambot/ReachGoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ReachGoalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dreambot.msg.ReachGoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dreambot.msg.ReachGoalResult()
