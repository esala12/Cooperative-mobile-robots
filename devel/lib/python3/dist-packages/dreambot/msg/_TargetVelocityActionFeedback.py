...
"""autogenerated by genpy from dreambot/TargetVelocityActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TargetVelocityActionFeedback(genpy.Message):
  _md5sum = "abd7a3a530092afd199f25d16b1751a3"
  _type = "dreambot/TargetVelocityActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dreambot/TargetVelocityFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TargetVelocityActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dreambot.msg.TargetVelocityFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dreambot.msg.TargetVelocityFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.success,) = _get_struct_B().unpack(str[start:end])
      self.feedback.success = bool(self.feedback.success)
      return self
