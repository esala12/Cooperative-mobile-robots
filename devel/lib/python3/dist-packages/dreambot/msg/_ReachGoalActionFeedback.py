...
"""autogenerated by genpy from dreambot/ReachGoalActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ReachGoalActionFeedback(genpy.Message):
  _md5sum = "38f9d29e68ce9c1f364514cda9c83dcb"
  _type = "dreambot/ReachGoalActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dreambot/ReachGoalFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ReachGoalActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dreambot.msg.ReachGoalFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dreambot.msg.ReachGoalFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.distance_to_goal,) = _get_struct_d().unpack(str[start:end])
      return self
