...
"""autogenerated by genpy from dreambot/ControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class ControlActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "dreambot/ControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dreambot/ControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dreambot.msg.ControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dreambot.msg.ControlResult()
