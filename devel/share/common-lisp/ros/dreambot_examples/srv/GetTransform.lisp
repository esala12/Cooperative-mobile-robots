...
(cl:in-package dreambot_examples-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetTransform-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTransform-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dreambot_examples-srv:<GetTransform-request> is deprecated: use dreambot_examples-srv:GetTransform-request instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <GetTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dreambot_examples-srv:frame_id-val is deprecated.  Use dreambot_examples-srv:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'child_frame_id-val :lambda-list '(m))
(cl:defmethod child_frame_id-val ((m <GetTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dreambot_examples-srv:child_frame_id-val is deprecated.  Use dreambot_examples-srv:child_frame_id instead.")
  (child_frame_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetTransform-request>)))
  ...
  "dreambot_examples/GetTransformRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTransform-request)))
  "Returns string type for a service object of type 'GetTransform-request"
  "dreambot_examples/GetTransformRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetTransform-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTransform-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dreambot_examples-srv:<GetTransform-response> is deprecated: use dreambot_examples-srv:GetTransform-response instead.")))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <GetTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dreambot_examples-srv:transform-val is deprecated.  Use dreambot_examples-srv:transform instead.")
  (transform m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GetTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dreambot_examples-srv:success-val is deprecated.  Use dreambot_examples-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetTransform-response>)))
  ...
  "dreambot_examples/GetTransformResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTransform-response)))
  "Returns string type for a service object of type 'GetTransform-response"
  "dreambot_examples/GetTransformResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTransform)))
  ...
  "dreambot_examples/GetTransform")