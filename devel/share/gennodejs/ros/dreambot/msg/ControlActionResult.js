...
class ControlActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ControlResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControlActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ControlResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ControlResult()
    }
...
module.exports = ControlActionResult;
