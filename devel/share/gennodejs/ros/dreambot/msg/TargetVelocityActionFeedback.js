...
let TargetVelocityFeedback = require('./TargetVelocityFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class TargetVelocityActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TargetVelocityFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TargetVelocityFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TargetVelocityActionFeedback(null);
    ...
    data.feedback = TargetVelocityFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TargetVelocityActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TargetVelocityFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TargetVelocityFeedback()
    }
...
module.exports = TargetVelocityActionFeedback;
