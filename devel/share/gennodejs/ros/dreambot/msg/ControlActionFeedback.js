...
class ControlActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ControlFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ControlFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ControlActionFeedback(null);
    ...
    data.feedback = ControlFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControlActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ControlFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ControlFeedback()
    }
...
module.exports = ControlActionFeedback;
