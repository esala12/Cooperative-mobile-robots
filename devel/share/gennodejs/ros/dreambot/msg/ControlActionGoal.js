...
class ControlActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ControlGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControlActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ControlGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ControlGoal()
    }
...
module.exports = ControlActionGoal;
