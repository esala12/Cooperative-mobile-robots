...
// (in-package dreambot_examples.srv)
...
class GetTransformRequest {
  ...
  static datatype() {
    ...
    return 'dreambot_examples/GetTransformRequest';
  }
...
class GetTransformResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dreambot_examples/GetTransformResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'dreambot_examples/GetTransform'; }
};
