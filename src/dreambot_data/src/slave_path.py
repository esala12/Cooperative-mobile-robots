...
class slaveFilterDataCollector:
    def __init__(self):
        # Set the path for the CSV file
        self.csv_file_path = os.path.expanduser('~/data/slave_filter_data.csv')
        ...
        self.subscriber = rospy.Subscriber('/slave_filter', Odometry, self.odometry_callback)
...
if __name__ == '__main__':
    ...
    rospy.init_node('slave_filter_data_collector')
    collector = slaveFilterDataCollector()
    rospy.spin()
